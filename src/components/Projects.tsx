...
const items = [
  {
    ...
    title: 'Blender',
    description:
      'A spectral‑morphing VST3/AU plugin developed in collaboration with the band Polyphia, featuring a built‑in sample library and seamless Splice integration. Designed for all major DAWs, it blends advanced sound‑shaping tools with an intuitive workflow to inspire new textures, tones, and creative possibilities.',
  ...
  },
  {
    ...
    description:
      'A MIDI‑generation research project using Transformer models and LLMs, designed specifically for guitar composition. It focuses on generating expressive chord progressions, riffs, and stylistic patterns by modeling musical structure and performance nuance. A demo guitar riff generated by one of the finetuned Transformer models can be heard by clicking the speaker.',
